...
\setlength\itemsep{2em}
  \item
  Developed countries : USA, UK, Germany, France, Sweden
	\item
  Emerging markets : South Korea, Brazil, China, Mexico, Colombia
\end{itemize}
...
## Israel EPU and VIX move together but also capture different aspects of uncertainty

```{r plot_israel_epu_vs_vix}


benchmark_df %>% 
  select(date, Israel = epu, VIX = vix) %>% 
  filter(complete.cases(.)) %>% 
...
# Robustness
## Robustness - Is Israel in line with common results?
...
B - coefficient matrix \textcolor{red}{at 8 lags}
...
## Robustness (log changes specification)
